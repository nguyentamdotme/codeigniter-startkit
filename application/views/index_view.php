  ...
  <head>
  	...
  	<!-- Generic page styles -->
  	<link rel="stylesheet" href="<?= site_url('assets/fileUpload/css/style.css'); ?>">
  	<!-- blueimp Gallery styles -->
  	<link rel="stylesheet" href="//blueimp.github.io/Gallery/css/blueimp-gallery.min.css">
  	<!-- CSS to style the file input field as button and adjust the Bootstrap progress bars -->
  	<link rel="stylesheet" href="<?= site_url('assets/fileUpload/css/jquery.fileupload.css'); ?>">
  	<link rel="stylesheet" href="<?= site_url('assets/fileUpload/css/jquery.fileupload-ui.css'); ?>">
  	<!-- CSS adjustments for browsers with JavaScript disabled -->
  	<noscript><link rel="stylesheet" href="<?= site_url('assets/fileUpload/css/jquery.fileupload-noscript.css'); ?>"></noscript>
  	<noscript><link rel="stylesheet" href="<?= site_url('assets/fileUpload/css/jquery.fileupload-ui-noscript.css'); ?>"></noscript>
  </head>
  <body>
  <div class="container">
