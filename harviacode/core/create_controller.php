...
$string .= "
    ...
    $string .= "\n\n    public function pageOutput(\$page, \$data = null)
    {
...
$string .= "\n\n    public function index()
    {
        ...
        \$this->pageOutput('$c_url/$v_list', \$data);
    }";
...
$string .= "\n\t    );
            \$this->pageOutput('$c_url/$v_read', \$data);
        } else {
...
$string .= "\n\t);
        \$this->pageOutput('$c_url/$v_form', \$data);
    }
