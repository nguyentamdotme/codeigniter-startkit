...
$string .="\n\n    // datatables
    function json() {
        ...
        \$this->datatables->add_column('action', anchor(site_url('".$c_url."/read/\$1'),'&nbsp','class=\"fa fa-eye\"').\" |&nbsp \".anchor(site_url('".$c_url."/update/\$1'),'&nbsp', 'class=\"fa fa-pencil-square-o\"').\" |&nbsp \".anchor(site_url('".$c_url."/delete/\$1'),'&nbsp',array('onclick'=>'\"javasciprt: return confirm(\\'Are You Sure ?\\')\"', 'class' => 'fa fa-trash')), '$pk');
