        ...
        <div class="row">
            <div class="col-md-3">
                <form action="index.php" method="POST">
                    ...
                    <div class="form-group">
                        <label>Custom URL Controller</label>
                        <input type="text" id="url-controller" name="url-controller" value="<?php echo isset($_POST['url-controller']) ? $_POST['url-controller'] : '' ?>" class="form-control" placeholder="URL Controller" />
                    </div>
            ...
            <div class="col-md-9">
                <h3 style="margin-top: 0px">CRUD Generator</h3>
...
<hr>
                <p><strong>If you use Custom URL Controller:</strong></p>
                <ul>
                  <li>On application/config/routers.php, set :</b>.
                    <ul>
                      <li>
                        $route['URLCustomController'] = 'ControllerName';
                      </li>
                      <li>
                        $route['URLCustomController/json'] = 'ControllerName/json';
                      </li>
                      <li>
                        $route['URLCustomController/excel'] = 'ControllerName/excel';
                      </li>
                      <li>
                        $route['URLCustomController/create'] = 'ControllerName/create';
                      </li>
                      <li>
                        $route['URLCustomController/_rules'] = 'ControllerName/_rules';
                      </li>
                      <li>$route['URLCustomController/create_action'] = 'ControllerName/crea
                        te_action';
                      </li>
                      <li>$route['URLCustomController/update_action'] = 'ControllerName/upda
                        te_action';
                      </li>
                      <li>$route['URLCustomController/read/(:any)'] = 'ControllerName/read
                        /$1';
                      </li>
                      <li>$route['URLCustomController/update/(:any)'] = 'ControllerName/upda
                        te/$1';
                      </li>
                      <li>$route['URLCustomController/delete/(:any)'] = 'ControllerName/dele
                        te/$1';
                      </li>
